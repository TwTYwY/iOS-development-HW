...
final class WishMakerController: UIViewController {
    ...
    private func configureTitle() {
        ...
        titleLabel.textColor = Constants.pinkColor
    ...
    private func configureSliders() {
        ...
        let sliderRed = CustomSlider(title: "Red", min: Constants.colorMin, max: Constants.colorMax)
        let sliderBlue = CustomSlider(title: "Blue", min: Constants.colorMin, max: Constants.colorMax)
        let sliderGreen = CustomSlider(title: "Green", min: Constants.colorMin, max: Constants.colorMax)
        ...
        NSLayoutConstraint.activate([
            ...
            stack.bottomAnchor.constraint(equalTo: addWishButton.topAnchor, constant: -15)
        ])
